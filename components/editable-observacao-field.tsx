...
export function EditableObservacaoField({
    ...
    return (
      <div className={`space-y-3 ${className}`}>
        <Textarea
          ...
          className="min-h-[120px] resize-none border-orange-500 bg-black text-white focus:border-orange-400"
  ...
  return (
    <div
      className={`group cursor-pointer rounded-lg border border-orange-400 bg-black p-3 transition-colors hover:bg-[#1f1306] ${className}`}
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-white">Observação do Vendedor</span>
          </div>
          <div className="text-sm text-white whitespace-pre-line leading-relaxed min-h-[60px]">
            {currentObservacao || (
